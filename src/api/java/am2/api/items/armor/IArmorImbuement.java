...
public interface IArmorImbuement {
     ...
     * @param params      Depends on the application type. <br/>
     *                    In the case of ON_TICK, it will be a 1-length array with the first element being the
     *                    LivingEvent event <br/>
     *                    In the case of ON_JUMP, it will be a 1-length array with the first element being the
     *                    LivingJumpEvent event<br/>
     *                    In the case of ON_HIT, it will be a 1-length array with the first element being the
     *                    LivingHurtEvent event<br/>
     *                    In the case of ON_MINING_SPEED, it will be a 1-length array with the first element being the
     *                    BreakSpeed event <br/>
     */
