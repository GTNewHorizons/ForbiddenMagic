...
public interface IBeamParticle {
    ...
    /**
     * Indicates that this beam is being cast by a player that is in first person. Should only be called when creating a
     * beam from the local player, if the player is in first person. <br />
