...
public interface IIllEffect extends Comparable {
    ...
    /**
     * Gets the localized description of this ill effect as pertains to the affected entity player. This will only be
     * called based on your own class, so you can assume the metadata matches your metadata output from ApplyIllEffect.
     */
