...
public interface ISpellModifier extends ISpellPart {
     ...
     * @param stage      The stage in which this modifier has been added (if the modifier is added to multiple stages,
     *                   this will be called multiple times, once per stage)
     * @param quantity   The quantity of this multiplier in the specified stage.
     */
    public float getManaCostMultiplier(ItemStack spellStack, int stage, int quantity);

    /**
     * Gets any metadata needed by this modifier for the current spell. Used, for example, in the color modifier to
     * determine what color was specified.
     * 
     * @param stage         The stage this modifier is at
     * @param matchedRecipe The items that were added to the crafting altar which resulted in the matching of the
     *                      recipe.
     */
