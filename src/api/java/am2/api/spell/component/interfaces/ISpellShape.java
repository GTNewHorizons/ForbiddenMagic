...
public interface ISpellShape extends ISpellPart {
     ...
     * @param target   The specified target of the spell. If this is not NULL, this is a forced target, and should be
     *                 included with any other targets of the shape. Otherwise the default spell shape logic should
     *                 apply.
    ...
    public SpellCastResult beginStackStage(ItemSpellBase item, ItemStack stack, EntityLivingBase caster,
            EntityLivingBase target, World world, double x, double y, double z, int side, boolean giveXP, int useCount);
     ...
     * 
     * @param spellStack the itemstack representing the spell (useful if you want to vary based on added modifiers as
     *                   well, for example)
     * @return
     */
