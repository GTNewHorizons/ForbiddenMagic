...
public interface ISpellComponent extends ISpellPart {
    ...
    /**
     * Gets any reagents that must be present in the caster's inventory in order to cast the spell.
     */
    ...
    /**
     * Gets the amount (before diminishing returns) that this component, when successfully applied, shifts the caster's
     * affinity
     * 
