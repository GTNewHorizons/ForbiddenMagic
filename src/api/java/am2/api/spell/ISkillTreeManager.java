...
public interface ISkillTreeManager {
    ...
    /**
     * Registers a spell part into the skill tree (where it can be unlocked). Pass a null prerequisite for no
     * prerequisite. Throws an exception if the prerequisite passed in is not a registered entry in the skill tree, or
     * if it is in a different tree.
     * 
     ...
     */
    public void RegisterPart(ISkillTreeEntry part, int x, int y, SkillTrees tree, SkillPointTypes requiredPoint,
            ISkillTreeEntry... prerequisites);
}
