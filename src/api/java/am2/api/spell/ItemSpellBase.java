...
/**
 * This is just here for reference - you shouldn't have any need to inherit from this item. To add new parts to spells,
 * inherit from ISpellShape, ISpellModifier, or ISpellComponent.
 * 
 * @author Mithion
 *
 */
public abstract class ItemSpellBase extends Item {
     ...
     */
    public abstract MovingObjectPosition getMovingObjectPosition(EntityLivingBase caster, World world, double range,
            boolean targetEntities, boolean targetWater);
}
