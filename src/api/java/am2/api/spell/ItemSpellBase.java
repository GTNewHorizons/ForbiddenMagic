...
public abstract class ItemSpellBase extends Item {
     ...
     */
    public abstract MovingObjectPosition getMovingObjectPosition(
            EntityLivingBase caster, World world, double range, boolean targetEntities, boolean targetWater);
}
