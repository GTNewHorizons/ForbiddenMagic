...
public interface ISpellPartManager {
     ...
     * @param name      The unlocalized name you want to register it to. Local translations are
     *                  am2.spell.unlocalized_name, so register this into the language registry for localization.
