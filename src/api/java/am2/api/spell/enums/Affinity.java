...
public enum Affinity {
    ...
    NONE(0, 0xFFFFFF, -1, // no direct opposite
            new int[] {}, // no major opposites
            new int[] {}, // no minor opposites
            new int[] {}),

    ARCANE(1, 0xb935cd, 9, // nature is direct opposite
    ...
    WATER(2, 0x0b5cef, 3, // fire is direct opposite
    ...
    FIRE(3, 0xef260b, 2, // water is direct opposite
    ...
    EARTH(4, 0x61330b, 5, // air is direct opposite
    ...
    AIR(5, 0x777777, 4, // earth is direct opposite
    ...
    LIGHTNING(6, 0xdece19, 7, // ice is direct opposite
    ...
    ICE(7, 0xd3e8fc, 6, // lightning is direct opposite
    ...
    NATURE(8, 0x228718, 6, // arcane is direct opposite
    ...
    LIFE(9, 0x34e122, 10, // ender is direct opposite
    ...
    ENDER(10, 0x3f043d, 9, // life is direct opposite
    ...
    private Affinity(int ID, int color, int directOppositeAffinity, int[] majorOppositions, int[] minorOppositions,
            int[] adjacentAffinities) {
        this.ID = ID;
    ...
    public Affinity getOpposingAffinity() {
        if (this.directOpposingAffinity > -1) return Affinity.values()[this.directOpposingAffinity];
