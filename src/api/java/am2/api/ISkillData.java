...
public interface ISkillData {
    ...
    /**
     * Learns the specified entry. This will attempt to decrement skill points but is not bounded by it - make sure you
     * check {@link #getLearnState(SkillTreeEntry, EntityPlayer)} first!
     * 
     * @param entry
     */
    ...
    /**
     * Forces changes to sync to appropriate clients. Chances are you won't have to call this, as the sync will happen
     * at regular intervals if there are actually changes to sync. This is for when you need the changes clientside
     * immediately.
     */
    void forceSync();
