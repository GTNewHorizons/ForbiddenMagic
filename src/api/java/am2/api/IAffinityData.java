...
public interface IAffinityData {
    ...
    /**
     * Increments the affinity by the specified amount, and decrements other affinities by an amount related to how much
     * in opposition they are to the specified affinity.
     * 
