...
public class DarkEnchantments {
    ...
    public static void hex() {
        ...
        if (Compat.tt) {
            try {
                Method reg = Class.forName("thaumic.tinkerer.common.enchantment.core.EnchantmentManager")
                        .getDeclaredMethod(
                ...
                reg.invoke(
                        null,
                        wrath,
                        "forbidden:textures/misc/wrath.png",
                        false,
                        (new AspectList()).add(Aspect.ENTROPY, 6).add(Aspect.FIRE, 6),
                        "WRATH");
                reg.invoke(
                        null,
                        cluster,
                ...
                reg.invoke(
                        null,
                        consuming,
                        "forbidden:textures/misc/consuming.png",
                        false,
                ...
                reg.invoke(
                        null,
                        voidtouched,
                        "forbidden:textures/misc/voidtouched.png",
                        false,
                ...
                reg.invoke(
                        null,
                        impact,
                        "forbidden:textures/misc/impact.png",
                        false,
                        (new AspectList()).add(Aspect.ENTROPY, 30).add(Aspect.EARTH, 30),
                        "IMPACT");
            } catch (Throwable e) {
                e.printStackTrace();
            }
