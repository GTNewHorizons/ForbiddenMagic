    ...
    public static void addAspects() {
        ...
        while (mobCount.hasNext()) {
            ...
            if (mobTag.entityName.equals("BrainyZombie")) {
                ...
                if (mobTag.nbts.length > 0) mobTag.aspects.add(WRATH, 4);
                else mobTag.aspects.add(WRATH, 2);
        ...
        ThaumcraftApi.registerObjectTag(
                ...
                (new AspectList()).add(NETHER, 1).add(WRATH, 2).add(Aspect.CRYSTAL, 1));
        ThaumcraftApi.registerObjectTag(
                new ItemStack(ForbiddenItems.deadlyShards, 1, 1),
                (new AspectList()).add(NETHER, 1).add(ENVY, 2).add(Aspect.CRYSTAL, 1));
        ThaumcraftApi.registerObjectTag(
                new ItemStack(ForbiddenItems.deadlyShards, 1, 2),
                (new AspectList()).add(Aspect.TAINT, 3).add(Aspect.CRYSTAL, 1));
        ThaumcraftApi.registerObjectTag(
        ...
        ThaumcraftApi.registerObjectTag(
                ...
                (new AspectList()).add(NETHER, 1).add(SLOTH, 2).add(Aspect.CRYSTAL, 1));
        ThaumcraftApi.registerObjectTag(
        ...
        ThaumcraftApi.registerObjectTag(
                new ItemStack(ForbiddenItems.taintCoal, 1, OreDictionary.WILDCARD_VALUE),
                (new AspectList()).add(Aspect.TAINT, 2).add(Aspect.ENTROPY, 2));
        ThaumcraftApi.registerObjectTag(
                new ItemStack(ForbiddenBlocks.taintLeaves, 1, OreDictionary.WILDCARD_VALUE),
                (new AspectList()).add(Aspect.TAINT, 1).add(Aspect.PLANT, 1));
        ThaumcraftApi.registerObjectTag(
                new ItemStack(ForbiddenBlocks.taintLog, 1, OreDictionary.WILDCARD_VALUE),
                (new AspectList()).add(Aspect.TAINT, 1).add(Aspect.TREE, 3));
        ThaumcraftApi.registerObjectTag(
