...
public class ForbiddenResearch {
    ...
    public static void addResearch() {
        ...
        if (thaumcraft.common.config.Config.researchDifficulty != -1)
            (new DarkResearchItem(
                    ...
                    .setParents(new String[] {"RESEARCH"})
        ...
        if (Config.emeraldTrans)
            (new DarkResearchItem(
                    ...
                    .setSecondary()
                    .setConcealed()
                    .setParents(new String[] {"TRANSGOLD"})
                    .registerResearchItem();
        (new DarkResearchItem(
                        "BLACKFLOWER",
                        "FORBIDDEN",
                ...
                .setAspectTriggers(new Aspect[] {Aspect.SENSES})
                .registerResearchItem();
        (new DarkResearchItem(
                        "RIDINGCROP",
                        "FORBIDDEN",
        ...
        if (Config.enchanting) {
            (new DarkResearchItem(
                    ...
                    .setParents(new String[] {"INFUSIONENCHANTMENT"})
                    .setSecondary()
                    .setConcealed()
                    .registerResearchItem();
            (new DarkResearchItem(
        ...
        if (Compat.botan || Compat.bm || Compat.am2)
            (new DarkResearchItem(
                            "SCHOOLS", "FORBIDDEN", new AspectList(), -1, 1, 0, new ItemStack(Blocks.enchanting_table)))
    ...
    public static void addInfernalism() {
        ...
        if (!Config.noLust)
            (new DarkResearchItem(
                    ...
                    .setParents(new String[] {"NETHERSHARDS", "VISAMULET", "INFUSION"})
                    .setHidden()
                    .setAspectTriggers(new Aspect[] {DarkAspects.LUST})
                    .registerResearchItem();
        ...
        (new DarkResearchItem(
                ...
                .setParents(new String[] {"NETHERSHARDS", "THAUMIUM", "INFUSION"})
                .setConcealed()
                .registerResearchItem();
        ...
        if (Config.gluttony != 1) {
            ...
            (new DarkResearchItem(
                    ...
                    .setAspectTriggers(new Aspect[] {DarkAspects.GLUTTONY})
                    .setConcealed()
                    .registerResearchItem();
        }
        (new DarkResearchItem(
        ...
        if (Config.enchanting) {
            (new DarkResearchItem(
                    ...
                    .setParents(new String[] {"NETHERSHARDS", "INFUSIONENCHANTMENT"})
                    .setConcealed()
                    .registerResearchItem();
            ...
            (new DarkResearchItem(
                    ...
                    .setParents(new String[] {"MORPHTOOLS", "ELEMENTALPICK"})
                    .setSecondary()
                    .setConcealed()
                    .registerResearchItem();
            (new DarkResearchItem(
                    ...
                    .setParents(new String[] {"MORPHTOOLS", "ELEMENTALSHOVEL"})
                    .setConcealed()
                    .registerResearchItem();
            (new DarkResearchItem(
                            "VOIDTOUCHED",
                    ...
                    .setParents(new String[] {"MORPHTOOLS", "VOIDMETAL"})
                    .setConcealed()
                    .registerResearchItem();
        ...
        if (Config.wrathCage) {
            (new DarkResearchItem(
                    ...
                    .setParents(new String[] {"INFUSION", "NETHERSHARDS", "THAUMIUM"})
                    .setSecondary()
                    .setConcealed()
                    .registerResearchItem();
            if (Config.wrathCost > 0)
                (new DarkResearchItem(
                        ...
                        .setParentsHidden(new String[] {"INFUSION", "THAUMIUM", "DISTILESSENTIA"})
                        .setConcealed()
                        .registerResearchItem();
            else
                (new DarkResearchItem(
    ...
    public static void addTaint() {
        (new DarkResearchItem(
                ...
                .setParents(new String[] {"THAUMIUM", "INFUSION", "ETHEREALBLOOM"})
                .setConcealed()
                .registerResearchItem();
        (new DarkResearchItem(
                        "TAINTPICK",
                ...
                .setParents(new String[] {"THAUMIUM", "INFUSION"})
                .setConcealed()
                .registerResearchItem();
        (new DarkResearchItem(
                        "ROD_tainted",
                ...
                .setPages(new ResearchPage[] {
                    new ResearchPage("forbidden.research_page.ROD_tainted.1"),
                    new ResearchPage((InfusionRecipe) recipes.get("WandRodTainted"))
                })
                .setParents(new String[] {"ROD_silverwood", "TAINTSHOVEL", "INFUSION"})
                .setConcealed()
                .registerResearchItem();
        (new DarkResearchItem(
                        "TAINTTREE",
