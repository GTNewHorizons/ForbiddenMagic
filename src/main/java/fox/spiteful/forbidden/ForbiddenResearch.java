...
public class ForbiddenResearch {
    ...
    public static void addResearch() {
        ResearchCategories.registerCategory(
                "FORBIDDEN",
                new ResourceLocation("forbidden", "textures/misc/forbidden.png"),
                new ResourceLocation("forbidden", "textures/misc/runecircle.png"));

        addInfernalism();
        addTaint();

        if (thaumcraft.common.config.Config.researchDifficulty != -1) (new DarkResearchItem(
                "CRYSTALWELL",
                "FORBIDDEN",
                (new AspectList()).add(Aspect.MIND, 3).add(Aspect.CRYSTAL, 2).add(Aspect.MAGIC, 1),
                -2,
                -8,
                1,
        ...
        (new DarkResearchItem(
                "PRIMEWELL",
                "FORBIDDEN",
                (new AspectList()).add(Aspect.MIND, 3).add(Aspect.ELDRITCH, 6).add(Aspect.CRAFT, 1),
                2,
                -8,
                1,
        ...
        if (Config.emeraldTrans) (new DarkResearchItem(
                "TRANSEMERALD",
                "FORBIDDEN",
                (new AspectList()).add(Aspect.CRYSTAL, 2).add(Aspect.EXCHANGE, 5).add(Aspect.GREED, 4),
                0,
                -6,
                3,
        ...
        (new DarkResearchItem(
                "BLACKFLOWER",
                "FORBIDDEN",
                (new AspectList()).add(Aspect.PLANT, 3).add(Aspect.SENSES, 2).add(Aspect.DARKNESS, 4),
                -2,
                -6,
                1,
        ...
        if (Config.enchanting) {
            (new DarkResearchItem(
                    "CONSUMING",
                    "FORBIDDEN",
                    (new AspectList()).add(Aspect.VOID, 4).add(Aspect.ENTROPY, 3).add(Aspect.MAGIC, 2),
                    -4,
                    -8,
                    1,
            ...
            (new DarkResearchItem(
                    "EDUCATIONAL",
                    "FORBIDDEN",
                    (new AspectList()).add(Aspect.MIND, 5).add(Aspect.WEAPON, 1).add(Aspect.MAGIC, 3),
                    -4,
                    -7,
                    2,
    ...
    public static void addInfernalism() {
        ...
        (new DarkResearchItem(
                "HELLFIRE",
                "FORBIDDEN",
                (new AspectList()).add(Aspect.FIRE, 3).add(DarkAspects.NETHER, 4).add(Aspect.TRAVEL, 2),
                -8,
                -8,
                1,
        ...
        if (!Config.noLust) (new DarkResearchItem(
                "SUBCOLLAR",
                "FORBIDDEN",
                (new AspectList().add(Aspect.AURA, 3).add(DarkAspects.LUST, 8).add(Aspect.MAGIC, 3).add(Aspect.TRAP, 6)
                        .add(Aspect.FLESH, 4)),
                -11,
                -5,
                2,
        ...
        (new DarkResearchItem(
                "SKULLAXE",
                "FORBIDDEN",
                (new AspectList()).add(Aspect.WEAPON, 3).add(DarkAspects.WRATH, 4).add(DarkAspects.NETHER, 1),
                -11,
                -7,
                2,
        ...
        if (Config.gluttony != 1) {
            (new DarkResearchItem(
                    "RINGFOOD",
                    "FORBIDDEN",
                    (new AspectList()).add(DarkAspects.GLUTTONY, 4).add(Aspect.HUNGER, 3).add(Aspect.LIFE, 2),
                    -11,
                    -6,
                    2,
            ...
            (new DarkResearchItem(
                    "ARCANECAKE",
                    "FORBIDDEN",
                    (new AspectList()).add(DarkAspects.GLUTTONY, 6).add(Aspect.HUNGER, 3).add(Aspect.CRAFT, 2),
                    -12,
                    -6,
                    2,
        ...
        (new DarkResearchItem(
                "FOCUSBLINK",
                "FORBIDDEN",
                (new AspectList()).add(Aspect.TRAVEL, 3).add(Aspect.ENTROPY, 3).add(DarkAspects.NETHER, 3)
                        .add(DarkAspects.SLOTH, 6),
                -11,
                -3,
                2,
        ...
        (new DarkResearchItem(
                "MORPHTOOLS",
                "FORBIDDEN",
                (new AspectList()).add(Aspect.TOOL, 2).add(DarkAspects.ENVY, 3).add(Aspect.EXCHANGE, 2),
                -9,
                -3,
                4,
        ...
        (new DarkResearchItem(
                "ROD_infernal",
                "FORBIDDEN",
                (new AspectList()).add(DarkAspects.NETHER, 4).add(Aspect.FIRE, 3).add(Aspect.TOOL, 1),
                -11,
                -4,
                3,
        ...
        if (Config.enchanting) {
            (new DarkResearchItem(
                    "WRATH",
                    "FORBIDDEN",
                    (new AspectList()).add(DarkAspects.WRATH, 16).add(Aspect.WEAPON, 20).add(Aspect.MAGIC, 10),
                    -6,
                    -3,
                    4,
            ...
            if (Config.greedyEnch) (new DarkResearchItem(
                    "GREEDY",
                    "FORBIDDEN",
                    (new AspectList()).add(Aspect.MAGIC, 2).add(Aspect.WEAPON, 1).add(Aspect.GREED, 3),
                    -6,
                    -5,
                    2,
            ...
            (new DarkResearchItem(
                    "CORRUPTING",
                    "FORBIDDEN",
                    (new AspectList()).add(DarkAspects.NETHER, 5).add(Aspect.CRYSTAL, 2).add(Aspect.EXCHANGE, 1),
                    -6,
                    -4,
                    1,
            ...
            (new DarkResearchItem(
                    "CLUSTER",
                    "FORBIDDEN",
                    (new AspectList()).add(Aspect.METAL, 1).add(Aspect.FIRE, 4).add(DarkAspects.ENVY, 3),
                    -10,
                    -1,
                    3,
            ...
            (new DarkResearchItem(
                    "IMPACT",
                    "FORBIDDEN",
                    (new AspectList()).add(Aspect.ENTROPY, 8).add(Aspect.TOOL, 10).add(Aspect.MINE, 16)
                            .add(DarkAspects.ENVY, 10),
                    -9,
                    -1,
                    3,
            ...
            (new DarkResearchItem(
                    "VOIDTOUCHED",
                    "FORBIDDEN",
                    (new AspectList()).add(Aspect.ELDRITCH, 16).add(Aspect.TOOL, 10).add(Aspect.CRAFT, 8)
        ...
        if (Config.wrathCage) {
            (new DarkResearchItem(
                    "FORK",
                    "FORBIDDEN",
                    (new AspectList()).add(DarkAspects.NETHER, 3).add(Aspect.MECHANISM, 1).add(Aspect.TOOL, 1),
                    -6,
                    -7,
                    0,
            ...
            if (Config.wrathCost > 0) (new DarkResearchItem(
                    "WRATHCAGE",
                    "FORBIDDEN",
                    (new AspectList()).add(DarkAspects.WRATH, 5).add(Aspect.MECHANISM, 3).add(Aspect.BEAST, 2),
                    -6,
                    -9,
                    4,
    ...
    public static void addTaint() {
        (new DarkResearchItem(
                "TAINTSHOVEL",
                "FORBIDDEN",
                (new AspectList()).add(Aspect.CRYSTAL, 3).add(Aspect.TAINT, 2).add(Aspect.TOOL, 1),
                -8,
                1,
                2,
        ...
        (new DarkResearchItem(
                "TAINTPICK",
                "FORBIDDEN",
                (new AspectList()).add(Aspect.TOOL, 2).add(Aspect.TAINT, 4).add(Aspect.ENTROPY, 3),
                -10,
                1,
                2,
        ...
        (new DarkResearchItem(
                "ROD_tainted",
                "FORBIDDEN",
                (new AspectList()).add(Aspect.MAGIC, 4).add(Aspect.TAINT, 5).add(Aspect.TOOL, 2),
                -8,
                3,
                3,
        ...
        (new DarkResearchItem(
                "TAINTTREE",
                "FORBIDDEN",
                (new AspectList()).add(Aspect.TREE, 4).add(Aspect.TAINT, 6).add(Aspect.POISON, 2).add(Aspect.PLANT, 3),
                -11,
                3,
                3,
        ...
        (new DarkResearchItem(
                "TAINTSTONE",
                "FORBIDDEN",
                (new AspectList()).add(Aspect.EARTH, 4).add(Aspect.TAINT, 6).add(Aspect.ORDER, 2),
                -10,
                3,
                2,
