 ...
 *
 * It was distributed as part of the Botania Mod. Get the Source Code in github: https://github.com/Vazkii/Botania
 *
...
public class SubTileBloodthorn extends SubTileFunctional {
    ...
    public void onUpdate() {
        ...
        final int range = 6;
        final int cost = 40;
        List<EntityLivingBase> entities = supertile.getWorldObj().getEntitiesWithinAABB(
        ...
        for (EntityLivingBase entity : entities) {
            if (!(entity instanceof EntityPlayer) && entity.getActivePotionEffect(Potion.weakness) == null
                    && mana >= cost
