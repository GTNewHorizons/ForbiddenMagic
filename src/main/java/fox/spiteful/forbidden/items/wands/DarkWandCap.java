...
/**
 * This class is used to keep the material information for the various caps. It is also used to generate the wand
 * recipes ingame.
 *
 * @author Azanor
 *
...
public class DarkWandCap extends WandCap {
    ...
    public DarkWandCap(String tag, float discount, List<Aspect> specialAspects, float discountSpecial, ItemStack item,
