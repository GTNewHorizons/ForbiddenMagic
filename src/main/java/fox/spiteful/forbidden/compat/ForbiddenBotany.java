    ...
    public static void flowerPowerHippymancy() {
        try {
            ...
            try {
                ...
                CraftingManager.getInstance().addRecipe(new ItemStack(resource, 1, 0), new Object[] {
                    "###", "###", "###", Character.valueOf('#'), new ItemStack(ForbiddenItems.resource, 1, 2)
                });
                CraftingManager.getInstance().addRecipe(new ItemStack(ForbiddenItems.resource, 9, 2), new Object[] {
                    "#", Character.valueOf('#'), new ItemStack(resource, 1, 0)
                });

                CraftingManager.getInstance().addRecipe(new ItemStack(resource, 1, 7), new Object[] {
                    "###", "###", "###", Character.valueOf('#'), new ItemStack(ForbiddenItems.resource, 1, 4)
                });
                CraftingManager.getInstance().addRecipe(new ItemStack(ForbiddenItems.resource, 9, 4), new Object[] {
                    "#", Character.valueOf('#'), new ItemStack(resource, 1, 7)
                });
            }
            ...
            if (Config.crossWand) {
                ...
                InfusionRecipe livingwood_rod = ThaumcraftApi.addInfusionCraftingRecipe(
                        "ROD_livingwood",
                        new ItemStack(ForbiddenItems.wandCore, 1, 8),
                        3,
                        (new AspectList())
                                .add(Aspect.MAGIC, 16)
                                .add(Aspect.TREE, 32)
                                ...
                                .add(Aspect.SENSES, 8)
                                .add(Aspect.PLANT, 8),
                        new ItemStack(livingLog),
                        new ItemStack[] {
                            new ItemStack(resource, 1, 2),
                            new ItemStack(rune, 1, 8),
                            new ItemStack(rune, 1, 0),
                            new ItemStack(rune, 1, 1),
                            new ItemStack(rune, 1, 2),
                            new ItemStack(rune, 1, 3),
                            new ItemStack(rune, 1, 4),
                            new ItemStack(rune, 1, 5),
                            new ItemStack(rune, 1, 6),
                            new ItemStack(rune, 1, 7)
                        });
                (new DarkResearchItem(
                        ...
                        .setParents(new String[] {"BOTANY", "ROD_silverwood", "INFUSION"})
                        .setConcealed()
                        .registerResearchItem();
                ...
                IArcaneRecipe manasteel_cap = ThaumcraftApi.addArcaneCraftingRecipe(
                        "CAP_manasteel",
                ...
                (new DarkResearchItem(
                        ...
                        .setPages(new ResearchPage[] {
                            new ResearchPage("forbidden.research_page.CAP_manasteel.1"), new ResearchPage(manasteel_cap)
                        })
                        .setParents(new String[] {"ROD_livingwood"})
                        .setSecondary()
                        .setConcealed()
                        .registerResearchItem();
                BotaniaAPI.registerManaInfusionRecipe(
                        new ItemStack(ForbiddenItems.wandCap, 1, 3), new ItemStack(ForbiddenItems.wandCap, 1, 4), 1000);

                InfusionRecipe dreamwood_rod = ThaumcraftApi.addInfusionCraftingRecipe(
                        "ROD_dreamwood",
                ...
                (new DarkResearchItem(
                        ...
                        .setSiblings(new String[] {"ROD_dreamwood"})
                        .setConcealed()
                        .registerResearchItem();
                (new DarkResearchItem("ROD_dreamwood", "FORBIDDEN"))
                        .setVirtual()
                        .registerResearchItem();
                ...
                (new DarkResearchItem(
                                ...
                                new ItemStack(ForbiddenItems.wandCap, 1, 5)))
                        .setPages(new ResearchPage[] {
                            new ResearchPage("forbidden.research_page.CAP_elementium.1"),
                            new ResearchPage(elementium_cap_inert),
                            new ResearchPage(elementium_cap)
                        })
                        .setParents(new String[] {"ROD_dreamwood_staff"})
                        .setConcealed()
                        .registerResearchItem();
                ...
                (new DarkResearchItem(
                                ...
                                "FORBIDDEN",
                                "[B]",
                                (new AspectList()).add(Aspect.ENERGY, 1).add(Aspect.METAL, 1),
                                3,
                                2,
                                1,
                                new ItemStack(ForbiddenItems.wandCap, 1, 2)))
                        ...
                        .setParents(new String[] {"CAP_manasteel"})
                        .setConcealed()
                        .setSecondary()
                        .registerResearchItem();
            }
            ...
            InfusionRecipe euclid = ThaumcraftApi.addInfusionCraftingRecipe(
                    "EUCLIDAISY",
                    euclidaisy,
                    8,
                    (new AspectList())
                            ...
                            .add(Aspect.MAGIC, 8),
                    new ItemStack(flower, 1, 6),
                    new ItemStack[] {
                        new ItemStack(ConfigItems.itemResource, 1, 14),
                        new ItemStack(resource, 1, 1),
                        new ItemStack(resource, 1, 6),
                        new ItemStack(petal, 1, 6),
                        new ItemStack(petal, 1, 6),
                        new ItemStack(rune, 1, 12),
                        new ItemStack(rune, 1, 11)
                    });
            (new DarkResearchItem(
                            "EUCLIDAISY",
                            "FORBIDDEN",
                            ...
                            euclidaisy))
                    .setPages(new ResearchPage[] {
                        new ResearchPage("forbidden.research_page.EUCLIDAISY.1"), new ResearchPage(euclid)
                    })
                    .setParents(new String[] {"BOTANY", "INFUSION"})
                    .setConcealed()
                    .registerResearchItem();
            ...
            (new DarkResearchItem(
                            ...
                            whisperweed))
                    .setPages(new ResearchPage[] {
                        new ResearchPage("forbidden.research_page.WHISPERWEED.1"), new ResearchPage(whispercraft)
                    })
                    .setParents(new String[] {"BOTANY"})
                    .setConcealed()
                    .registerResearchItem();
            ...
            InfusionRecipe thistlecraft = ThaumcraftApi.addInfusionCraftingRecipe(
                    "TAINTHISTLE",
                    tainthistle,
                    4,
                    (new AspectList())
            ...
            (new DarkResearchItem(
                            ...
                            tainthistle))
                    .setPages(new ResearchPage[] {
                        new ResearchPage("forbidden.research_page.TAINTHISTLE.1"), new ResearchPage(thistlecraft)
                    })
                    .setParents(new String[] {"BOTANY", "INFUSION"})
                    .setConcealed()
                    .registerResearchItem();
            ...
            if (Compat.bm) {
                ...
                SubTileBloodthorn.lexicon.addPage(
                        BotaniaAPI.internalHandler.textPage("forbidden.lexicon.bloodthorn.0"));
                ...
                try {
                    AltarRecipeRegistry.registerAltarRecipe(
                            bloodthorn, new ItemStack(flower, 1, 14), 4, 15000, 25, 50, false);
                } catch (Throwable e) {
            ...
            ThaumcraftApi.registerObjectTag(
                    new ItemStack(Compat.getItem("Botania", "specialFlower"), 1),
                    (new AspectList()).add(Aspect.PLANT, 4).add(Aspect.MAGIC, 1));
