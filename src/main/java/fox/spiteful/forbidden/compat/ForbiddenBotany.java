        ...
        try {
            ...
            if (Config.crossWand) {
                ...
                InfusionRecipe livingwood_rod = ThaumcraftApi.addInfusionCraftingRecipe(
                        ...
                        3,
                        (new AspectList()).add(Aspect.MAGIC, 16).add(Aspect.TREE, 32).add(Aspect.LIFE, 16)
                                .add(Aspect.SENSES, 8).add(Aspect.PLANT, 8),
                        new ItemStack(livingLog),
                        new ItemStack[] { new ItemStack(resource, 1, 2), new ItemStack(rune, 1, 8),
                                new ItemStack(rune, 1, 0), new ItemStack(rune, 1, 1), new ItemStack(rune, 1, 2),
                                new ItemStack(rune, 1, 3), new ItemStack(rune, 1, 4), new ItemStack(rune, 1, 5),
                                new ItemStack(rune, 1, 6), new ItemStack(rune, 1, 7) });
                (new DarkResearchItem(
                        "ROD_livingwood",
                        "FORBIDDEN",
                        "[B]",
                        (new AspectList()).add(Aspect.TREE, 8).add(Aspect.MAGIC, 4).add(Aspect.PLANT, 6),
                        -1,
                        3,
                        3,
                ...
                (new DarkResearchItem(
                        ...
                        "FORBIDDEN",
                        "[B]",
                        (new AspectList()).add(Aspect.AURA, 6).add(Aspect.MAGIC, 4).add(Aspect.METAL, 4),
                        1,
                        2,
                        2,
                ...
                (new DarkResearchItem(
                        ...
                        "FORBIDDEN",
                        "[B]",
                        (new AspectList()).add(Aspect.TREE, 16).add(Aspect.MAGIC, 8).add(Aspect.ELDRITCH, 6),
                        1,
                        3,
                        2,
                ...
                InfusionRecipe elementium_cap = ThaumcraftApi.addInfusionCraftingRecipe(
                        ...
                        1,
                        (new AspectList()).add(Aspect.EARTH, 18).add(Aspect.FIRE, 18).add(Aspect.WATER, 18)
                                .add(Aspect.AIR, 18),
                        new ItemStack(ForbiddenItems.wandCap, 1, 6),
                        new ItemStack[] { new ItemStack(resource, 1, 5), new ItemStack(rune, 1, 0),
                                new ItemStack(rune, 1, 1), new ItemStack(rune, 1, 2), new ItemStack(rune, 1, 3) });
                (new DarkResearchItem(
                        "CAP_elementium",
                        "FORBIDDEN",
                        "[B]",
                        (new AspectList()).add(Aspect.FIRE, 8).add(Aspect.MAGIC, 12).add(Aspect.WATER, 8)
                                .add(Aspect.AIR, 8).add(Aspect.EARTH, 8),
                        3,
                        3,
                        4,
            ...
            InfusionRecipe euclid = ThaumcraftApi.addInfusionCraftingRecipe(
                    ...
                    euclidaisy,
                    8,
                    (new AspectList()).add(Aspect.AURA, 8).add(Aspect.ELDRITCH, 10).add(Aspect.MAGIC, 8),
                    new ItemStack(flower, 1, 6),
                    new ItemStack[] { new ItemStack(ConfigItems.itemResource, 1, 14), new ItemStack(resource, 1, 1),
                            new ItemStack(resource, 1, 6), new ItemStack(petal, 1, 6), new ItemStack(petal, 1, 6),
                            new ItemStack(rune, 1, 12), new ItemStack(rune, 1, 11) });
            (new DarkResearchItem(
                    "EUCLIDAISY",
                    "FORBIDDEN",
                    "[B]",
                    (new AspectList()).add(Aspect.PLANT, 8).add(Aspect.MAGIC, 4).add(Aspect.AURA, 12),
                    -3,
                    5,
                    2,
                    euclidaisy))
            ...
            (new DarkResearchItem(
                    ...
                    "FORBIDDEN",
                    "[B]",
                    (new AspectList()).add(Aspect.PLANT, 8).add(Aspect.MIND, 10).add(Aspect.SENSES, 4),
                    -4,
                    5,
                    1,
                    whisperweed))
            ...
            InfusionRecipe thistlecraft = ThaumcraftApi.addInfusionCraftingRecipe(
                    ...
                    tainthistle,
                    4,
                    (new AspectList()).add(Aspect.TAINT, 8).add(Aspect.HUNGER, 4).add(Aspect.AIR, 4)
                            .add(Aspect.WATER, 4),
                    new ItemStack(ConfigItems.itemResource, 1, 12),
                    new ItemStack[] { new ItemStack(petal, 1, 10), new ItemStack(petal, 1, 10),
                            new ItemStack(petal, 1, 10), new ItemStack(rune, 1, 10), new ItemStack(rune, 1, 8) });
            (new DarkResearchItem(
                    "TAINTHISTLE",
                    "FORBIDDEN",
                    "[B]",
                    (new AspectList()).add(Aspect.PLANT, 8).add(Aspect.TAINT, 10).add(Aspect.MAGIC, 4),
                    -2,
                    5,
                    2,
                    tainthistle))
            ...
            if (Compat.bm) {
                ...
                SubTileBloodthorn.lexicon
                        .addPage(BotaniaAPI.internalHandler.textPage("forbidden.lexicon.bloodthorn.0"));

                ItemStack bloodthorn = getFlower("bloodthorn");
                SubTileBloodthorn.lexicon.setIcon(bloodthorn);
                try {
                    AltarRecipeRegistry
                            .registerAltarRecipe(bloodthorn, new ItemStack(flower, 1, 14), 4, 15000, 25, 50, false);
                } catch (Throwable e) {
