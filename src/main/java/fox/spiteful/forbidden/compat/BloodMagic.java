    ...
    public static void stab() {
        try {
            ...
            if (Config.crossWand) {
                ...
                InfusionRecipe blood_recipe = ThaumcraftApi.addInfusionCraftingRecipe(
                        ...
                        new ItemStack[] {
                            ...
                            new ItemStack(imbuedSlate),
                            new ItemStack(imbuedSlate),
                            new ItemStack(tennebrae),
                            new ItemStack(sanctus),
                            new ItemStack(aquasalus),
                            new ItemStack(incendium),
                            new ItemStack(terrae),
                ...
                (new DarkResearchItem(
                        ...
                        .setPages(new ResearchPage[] {
                            new ResearchPage("forbidden.research_page.ROD_blood.1"),
                            new ResearchPage(blood_recipe),
                            new ResearchPage("forbidden.research_page.ROD_blood.2")
                        })
                        .setParents(new String[] {"ROD_silverwood", "INFUSION", "BLOODMAGIC"})
                        .setConcealed()
                        .registerResearchItem();
                ...
                (new DarkResearchItem(
                                ...
                                new ItemStack(ForbiddenItems.wandCore, 1, 9)))
                        .setPages(new ResearchPage[] {
                            new ResearchPage("forbidden.research_page.ROD_blood_staff.1"), new ResearchPage(blood_staff)
                        })
                        .setParents(new String[] {"ROD_silverwood_staff", "ROD_blood"})
                        .setSpecial()
                        .setConcealed()
                        .registerResearchItem();
                ...
                InfusionRecipe alchemical_recipe = ThaumcraftApi.addInfusionCraftingRecipe(
                        ...
                        new ItemStack[] {new ItemStack(magicales), new ItemStack(magicales), new ItemStack(magicales)});
                (new DarkResearchItem(
                                "CAP_alchemical",
                                "FORBIDDEN",
                                "[BM]",
                                ...
                                new ItemStack(ForbiddenItems.wandCap, 1, 0)))
                        .setPages(new ResearchPage[] {
                            new ResearchPage("forbidden.research_page.CAP_alchemical.1"),
                            new ResearchPage(alchemical_recipe)
                        })
                        .setParents(new String[] {"ROD_blood", "CAP_gold"})
                        .setSecondary()
                        .setConcealed()
                        .registerResearchItem();
            }
            ...
            (new DarkResearchItem(
                            ...
                            new ItemStack(ForbiddenItems.bloodwell, 1, 0)))
                    .setPages(new ResearchPage[] {
                        new ResearchPage("forbidden.research_page.BLOODWELL.1"), new ResearchPage(bloodwell_recipe)
                    })
                    .setParents(new String[] {"BLOODMAGIC"})
                    .registerResearchItem();
            ...
            InfusionRecipe blood_rapier = ThaumcraftApi.addInfusionCraftingRecipe(
                    ...
                    new ItemStack[] {
                        ...
                        new ItemStack(ForbiddenItems.gluttonyShard, 1, 0),
            ...
            (new DarkResearchItem(
                            ...
                            new ItemStack(ForbiddenItems.bloodRapier, 1, 0)))
                    .setPages(new ResearchPage[] {
                        new ResearchPage("forbidden.research_page.BLOODRAPIER.1"), new ResearchPage(blood_rapier)
                    })
                    .setParents(new String[] {"BLOODMAGIC", "INFUSION", "VOIDMETAL"})
                    .setConcealed()
                    .registerResearchItem();
            ...
            (new DarkResearchItem(
                            ...
                            new ItemStack(ForbiddenItems.bloodOrb, 1, 0)))
                    .setPages(new ResearchPage[] {
                        new ResearchPage("forbidden.research_page.ELDRITCHORB.1"), new ResearchPage(eldritch_orb)
                    })
            ...
            BindingRegistry.registerRecipe(
                    new ItemStack(ForbiddenItems.boundwell, 1, 0), new ItemStack(ForbiddenItems.crystalwell, 1, 0));
            AlchemicalPotionCreationHandler.addPotion(
                    new ItemStack(ConfigItems.itemResource, 1, 11), PotionFluxTaint.instance.getId(), 450);
            AlchemicalPotionCreationHandler.addPotion(
                    new ItemStack(ForbiddenItems.resource, 1, 3), DarkPotions.bloodSeal.getId(), 1200);
